...
Cette IA se distingue de l'IA basée sur de grandes quantités de données d'entrainement qui occupe le devant de la scène depuis que la technologie des grands modèles de langage a été popularisée auprès du grand public.
...
Le chapitre 4 présente des recherches en cours illustrant une méthodologie de développement et d'expérimentation qui s'inscrit dans une logique de rétro-ingénierie de la cognition. 
