...
\noindent
Les fondements théoriques passés en revue dans ce chapitre apportent chacun des sources d'inspirations complémentaires pour proposer une vision de l'intelligence artificielle développementale.

Dans cette vision, la connaissance est fondamentalement empiriste au sens ou elle trouve ses origines dans l'expérience, ou selon le terme de Hume d'impression sensible. 
L'expérience des impressions sensible se comprends comme un flux d'événements ayant des propriétés, et ayant une valeur affective ou émotionnelle. 
La phénoménologie suggère que ce flux d'événements n'est pas un un flux d'observation ou de perception d'une réalité présupposée. 
L'agent n'observe pas directement une réalité constitué d'objets prédéfinis.
La philosophie du processus de Whitehead suggère que les événements sont premiers.   
Les propriétés de ces événements ne représentent pas des propriétés d'un environnement présupposée à l'extérieur de l'agent. 
...
Ce processus de construction nécessite néanmoins des présupposés: des préférences pour certaines impressions sensibles ainsi qu'une capacité à capturer une certaine séquentialités et certaines propriétés géométriques.  
Ces présupposés peuvent être compris comme hérités d'un processus évolutionniste, dans lequel chaque être vivant hérite de la capacité à construire un certain niveau de connaissance.

La phénoménologie tout autant que l'épistémologie pragmatique suggère que l'acquisition d'habitudes dans le traitement et la répétition d'événements d'expérience est cruciale. 
La construction de signification est étroitement liée à l'usage qui peut être fait des connaissances construites à partir des impressions sensibles pour produire d'autres impressions sensibles. 
Le processus d'acquisition d'habitudes peut lui-même obéir à une logique évolutionniste dans lequel les habitudes préférées sont conservées et celles défavorables oubliées.  
Le concept d'habitude renvoie lui-même à une forme d'\emph{inversion du raisonnement}  selon lequel le comportement précède la signification.


Les théories constuctivistes et développementales suggèrent de voir les événements d'impression sensible comme des schèmes qui peuvent faire l'objet d'une organisation et d'une complexification progressive au fur et à mesure du développement de l'individu. 
Un observateur extérieur peut voir ces schèmes comme des régularités d'interaction sensorimotrices entre l'agent et son environnement.
La psychologie développementale de Piaget suggère que le processus développemental de l'agent passe par la construction et l'organisation de schèmes de plus en plus sophistiqués pour régir les comportements de l'agent. 


Cette conceptions de la cognition se prête à des expérimentations et des simulations informatiques qui permettraient d'en faire la démonstration et de tester ses limites.
Je résume cette entreprise par le projet de concevoir un agent capables de construire et réitérer des comportements spatio-séquentiels hiérarchiques basés sur des préférences intéractionnelles initiales
