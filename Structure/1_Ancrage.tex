...
Il vise un double rôles. 
Le premier est d'établir un langage de référence largement admis dans la communauté scientifique pour parler des différents aspects de la cognition: expérience, apprentissage, connaissance, développement, attention, émotions, motivation, individuation. 
...
\noindent
On peut facilement dire en anglais que le projet de l'intelligence artificielle est de créer un \an{artificial mind} mais on utiliser rarement en français l'expression \emph{esprit artificiel} qui renverrait à d'autres connotations. 
Cette section vise à poser les bases de ce qu'on appelle \an{the mind}, comment il peut apprendre à partir de l'\emph{expérience}, comment il peut etre compris dans une logique évolutionniste dans lequel s'inscrit \an{the animal's mind}, comment il peut éventuellement tendre vers une connaissance objective, et comment on peut concevoir sa liberté.   
Cette section nous conduit à définir l'épistémologie génétique et constructiviste qui fondent les théories de l'apprentissage développemental. 
...
Cependant, même focalisée sur objet externe, elle implique le capacité intérieure de pouvoir éliciter une région de l'espace dans un modèle prédictif de façon à orienter le système sensorimoteur vers le point correspondant de l'environnement.
...
L'hypothèse de Buzsáki et Moser interprétée dans le cadre de l'IA suggère que de telles capacités pourrait constituer un socle sur lequel se construisent progressivement des capacités cognitives de plus haut niveau. 
...
Les signaux olfactifs y jouent un rôle central, mais ce comportement implique déjà un apprentissage sensorimoteur combinait également des indices tactiles et parfois thermiques. 
...
Dans cette vision, la connaissance est fondamentalement empiriste au sens ou elle trouve ses origines dans l'expérience, ou, selon le terme de Hume, les impressions sensibles. 
Ces impressions sensibles peuvent être vues comme un flux d'événements ayant des valeurs affectives ou émotionnelle. 
...
En complément de la phénoménologie, le pragmatisme souligner le rôle central des habitudes dans l'attribution de signification, et suggère une \emph{inversion du raisonnement} selon laquelle le comportement précède la signification plutôt qu'il n'en découle.
