...
Il y soutient que la pensée n'est pas le privilège d'une substance immatérielle mais une propriété de certaines matière organisée telles que les matières biologiques et le cerveau. 
Il formule de manière provocatrice cette thèse moniste: \og Concluons hardiment que l'homme est une machine et qu'il n'y a dans tout l'Univers qu'une seule substance \fg qui a été résumée par le slogan \og la matière peut penser \fg .
...
Cette vision encourage à doter des agents artificiels de prédispositions comportementales conçues par l'ingénieur de manière analogue aux prédispositions innées que les êtres vivants héritent de leur lignée évolutive, avec pour objectif de reproduire des mécanismes d'apprentissage analogues.
...
Il ne s'agit par se prétendre que le robot serait \og doté d'un système émotionnel \fg , et encore moins qu'il éprouve des émotions, mais simplement de s'inspirer de ces dimensions comportementales observées dans le vivant.
