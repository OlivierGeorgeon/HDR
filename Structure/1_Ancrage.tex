...
\noindent
La \an{Process Philosophy}, développée par Alfred North Whitehead dans son œuvre majeure \og \an{Process and Reality} \fg (1929), propose une nouvelle métaphysique appelée en français \og philosophie de l'organisme \fg\ ou \og philosophie du processus \fg. 
...
Vers la fin de sa vie, Piaget rapprochera l'épistémologie génétique de l'épistémologie constructiviste théorisée par d'autres auteurs comme Ernst von Glasersfeld \cite{von_glasersfeld_radical_1995}. 
...
Quoi qu'il en soit, l'épistémologie génétique est largement acceptée comme la référence fondatrice des théories cherchant à expliquer l'émergence de la connaissance à partir de la matière chimique et organique. 
...
Il ne s'agit pas de prétendre que le robot éprouverait des émotions ni même qu'il serait \og doté d'un système émotionnel \fg, mais plutôt d'examiner l'hypothèse que ce modèle permettrait de créer un robot qui mimerait les émotions et permettre des apprentissages ouverts.
...
Comme évoqué à la section \ref{sec:anatomie}, des capacités de calcul spatio-temporel sont présentes à tous les niveaux du découpage tripartite du cerveau. 
Dans le télencéphale, le complexe entorhinal-hippocampique joue un rôle central dans l'organisation des activités spatio-temporelles complexes. 
...
L'examen de ces mécanismes cérébraux me conduit à donner une place centrale aux capacités de représentations spatio-temporelles.
L'hypothèse de Buzsáki et Moser interprétée dans le cadre de l'IA suggère que de telles capacités pourraient constituer un socle sur lequel se construisent progressivement des capacités cognitives de plus haut niveau. 
Le constat que beaucoup de ces capacités reposent sur des prédispositions innées du cerveau soulève la question de savoir si elles pourraient être intégrées explicitement sous la forme de modules fonctionnels spécialisés. 
...
Les exemples sont multiples: construction de toiles chez les araignées, poursuite d'objets en mouvements chez les chiens et les chats, ou encore migration chez diverses espèces terrestres, volantes, ou aquatiques. 
...
Les signaux olfactifs y jouent un rôle central, mais ce comportement implique déjà un apprentissage sensorimoteur combinant également des indices tactiles et parfois thermiques. 
