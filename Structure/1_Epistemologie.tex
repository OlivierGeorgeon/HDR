...
Cet événement marque une transformation qui prolonge la pensée des Lumières en inscrivant progressivement l’intelligence dans une perspective naturaliste et évolutionniste.
...
Ces structures, héritées et progressivement modifiées, constituent le socle sur lequel se développent les capacités de connaitre et de raisonnement des êtres vivants.

Cette vision encourage le développement d’agents artificiels capables de construire leur propre connaissance du monde à partir de prédispositions initiales, conçues par l'ingénieur de manière analogue aux prédispositions innées que les êtres vivants héritent de leur lignée évolutive.
