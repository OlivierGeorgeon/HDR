...
\noindent
La révolution épistémologique des Lumières du XVIII\textsuperscript{e}~siècle a profondément renouvelé la manière de penser le savoir, la raison et l’expérience.
Dès la fin du XVII\textsuperscript{e}~siècle, le philosophe britannique John Locke en fut l'un des précurseurs en fondant \emph{l'empirisme}. 
En rupture avec le rationalisme cartésien qui le précédait, Locke élabore une critique décisive de l'innéisme et introduit la célèbre métaphore de la \emph{tabula rasa} pour désigner l’absence de connaissances à la naissance.
L'empirisme remet en cause la notion de vérité indubitable, innée ou issue d'une substance métaphysique, qui serait accessible à la raison seule.
...
Au cours de la seconde moitié du XVIII\textsuperscript{e}~siècle, Emmanuel Kant critique à la fois le rationalisme du début du XVII\textsuperscript{e}~siècle et l'empirisme qui lui a succédé \cite{kant_kritik_1781}.
...
Selon lui, toute expérience sensible est déjà conditionnée par les structures du sujet connaissant : les catégories de l'entendement et les formes \textit{a priori}, dont l'espace et le temps.
...
Par exemple, le schème de triangle est la règle de construction de tous les triangles possibles dans l'intuition.
...
La théorie darwinienne invite à concevoir les capacités cognitives comme le résultat d’un processus d’évolution phylogénétique du vivant, plutôt que comme des facultés abstraites, universelles et indépendantes de leur ancrage biologique.
...
L'intelligence peut être envisagée comme le produit d'une histoire évolutive ayant sélectionné des fonctionnalités cognitive, des biais perceptifs et décisionnels ainsi que des préférences innées.  
...
\noindent
Vers la fin du XIX\textsuperscript{e}~siècle, plusieurs penseurs américains ont proposé une transformation de l'empirisme en le recentrant sur la dimension pratique de l'expérience: c'est la naissance de \emph{l'épistémologie pragmatique}. 
...
Dans les années 1970, une équipe du \an{Artificial Intelligence Lab} du MIT autour du roboticien Rodney Brooks et du philosophe Hubert Dreyfus ont développé une approche de l'IA \og heideggeienne \fg donnant la place centrale aux comportements.
...
Il nous incite à utiliser les \emph{événements d'interaction} comme les briques élémentaires des connaissances construite par les systèmes artificiels. 

Whitehead propose des concepts utiles pour décrire la perception de la part d'entités qui ont une expérience de connexion au monde non consciente. 
Il fait la distinction entre deux modes de perception le mode le mode l'\emph{immédiateté présentationnelle} (dans le sens de \og percevoir une couleur \fg) et le mode de la \emph{causalité efficiente} (dans le sens de \og percevoir un objet \fg). 
Nous pouvons appliquer ces idées à des robots pour décrire deux modes de perception de la part des robots tout en reconnaissant qu'ils sont des entités non conscientes. 
Les signaux sensoriels sont présentés au robot sur le mode de l'immédiateté présentationnelle, et le robot apprend des régularités spatio-séquentielles d'action et de \an{feedback} sensoriels qui lui permet de construire un modèle causal qui rend compte du mode de l'efficience causale de la perception.
...
Le bio-chimiste Nick Lane exprime ainsi cette interrogation:

\begin{quote}
\an{The problem is we don't know what emotions are, [...]. 
	What is the feeling in physical terms?
	How does a discharging neuron give rise to a feeling of anything at all? 
	This is the hard problem of consciousness.
	The seeming duality of mind and matter, the physical make up of our innermost self.
	We can understand in principle how an extremely sophisicated parallel processing system could be capable of wondrous feats of intelligence. 
	But we can't answer in principle whether such a supreme intelligence would experience joy or melancholy.}
\cite{lane_transformer_2022}
\end{quote}
...
Le cerveau des vertébrés est classiquement subdivisé en trois grandes régions, souvent associées à des étapes successives de l’évolution phylogénétique : le \emph{cerveau postérieur} (rhombencéphale, \an{hindbrain}), le \emph{cerveau moyen} (mésencéphale, \an{midbrain}) et le \emph{cerveau antérieur} (prosencéphale, \an{forebrain}), comme illustré en Figure~\ref{fig:cerveau}.

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{Figures/1_cerveau.png}
	\caption{Les grandes régions du cerveau humain}
	\label{fig:cerveau}
\end{figure}

Le cerveau postérieur assure la régulation des fonctions vitales nécessaires à la survie de l’organisme, telles que la respiration, la pression artérielle, le rythme cardiaque et la digestion. 
Il relie le tronc cérébral aux autres structures cérébrales et joue un rôle clé dans la régulation de l’état d’éveil, de la conscience et des cycles veille–sommeil.
Il comprend notamment le cervelet, qui occupe une place centrale dans la coordination fine des mouvements et l’ajustement en temps réel des actions, en comparant en permanence les commandes motrices émises avec leurs conséquences sensorielles effectives.
Le cervelet contribue ainsi à la prédiction de l’évolution future de la position du corps et des objets à partir des informations sensorielles et motrices. 
...
Le cerveau moyen participe à l’intégration et au traitement précoce des informations sensorielles, en particulier somatosensorielles, visuelles et auditives. 
Il contient le tectum (colliculus supérieur et inférieur chez les mammifères), qui jouent un rôle majeur dans la localisation spatiale égocentrique des signaux sensoriels. 
Le tectum est une base essentielle pour l’intégration multimodale fondée sur des coïncidences spatiales et temporelles.
Il contient différentes couches qui forment des cartes spatiales alignées pour chaque modalité sensorielle, de sorte qu’un même point de l’espace est représenté de manière congruente pour la vision, l’audition et, chez certaines espèces, d’autres modalités telles que l’électrolocation. 
Ces cartes sensorielles sont inter-connectées avec des cartes motrices, ce qui  permettant une coordination sensorimotrice rapide \cite{isa_tectumsuperior_2021}.

Le cerveau antérieur est généralement considéré comme la région la plus récente sur le plan phylogénétique. 
Il comprend le diencéphale (thalamus et hypothalamus), impliqué dans la régulation des états internes en intégrant les motivations et désirs de toutes origines.
Il inclut également le télencéphale, constitué notamment des ganglions de la base, de l’hippocampe et du cortex cérébral, qui supporte les fonctions de mémoire, d’apprentissage et de prise de décision complexe.
...
Ce modèle propose une représentation continue de l’état émotionnel fondée sur la concentration relative de trois neuromodulateurs : la dopamine (DA), la sérotonine (5-HT) et la noradrénaline (NE), comme illustré en Figure~\ref{fig:emotions}.

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\linewidth]{Figures/1_Lovheim_cube_of_emotion.pdf}
	\caption{Le cube des émotions de Lövheim \cite[Fig.~1]{lovheim_new_2012}, délimité par les valeurs minimales et maximales de la sérotonine (5-HT), de la dopamine (DA) et de la noradrénaline (NE). 
		L’axe de la sérotonine est associé à la confiance et au bien-être, l’axe de la dopamine à l’engagement et à la recherche de récompense, et l’axe de la noradrénaline à la vigilance et à l’attention.}
	\label{fig:emotions}
\end{figure}

Lövheim justifie ce modèle en soulignant que les systèmes de contrôle du comportement reposant sur les monoamines sont observables à travers l’évolution de nombreuses espèces. 
Il les décrit comme centraux dans la modulation de comportements favorisant la survie, tout en présentant une dynamique suffisamment rapide pour permettre une adaptation efficace aux changements de l’environnement. 
Bien que chacun des trois neuromodulateurs soit associé à une dimension affective dominante, il insiste sur l’existence probable d’interactions dynamiques complexes entre eux.

Dans ce modèle, l’axe de la sérotonine renvoie à des aspects tels que la confiance en soi, la stabilité émotionnelle et le bien-être général, et peut être mis en relation avec des comportements d’apprentissage et d’exploration ludique. La dopamine est principalement associée au plaisir, à la motivation et à la recherche de récompense, jouant un rôle clé dans l’engagement dans l’action. Enfin, la noradrénaline est liée à la vigilance, à l’attention et à la réactivité face aux stimuli, et sous-tend des comportements de type combat ou fuite.

Talanov montre que l’intégration d’un modèle émotionnel inspiré du cube de Lövheim permet de concevoir des robots dont les actions ne sont pas uniquement dictées par des objectifs extrinsèques ou des règles prédéfinies, mais émergent également de dynamiques motivationnelles internes. 
...
Selon les états émotionnels internes, le robot peut ainsi privilégier des comportements d’exploration vers de nouvelles zones de l’environnement, initier des interactions afin de tester ou d’affiner son modèle interne du monde, ou encore focaliser son attention sur des objets ou des événements spécifiques.
