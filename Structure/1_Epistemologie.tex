...
\noindent
Alors que le pragmatisme se développait aux Etats-Unis, Edmund Husserl élabora en Europe la \emph{phénoménologie}, afin de se concentrer davantage sur l'étude de la conscience.
Martin Heidegger étendit ensuite la méthode phénoménologique à la compréhension de l'existence humaine comme \og être au monde \fg. 

L'ouvrage fondateur de de la phénoménologie, \og Recherches logiques \fg (1901) de Husserl affirme que \og toute conscience est toujours conscience de quelque chose \fg. 
...
Le cerveau des vertébrés est classiquement subdivisé en trois grandes régions qui reflètent l'organisation développementale du système nerveux au cours de l'embryogénèse : le \emph{cerveau postérieur} (rhombencéphale, \an{hindbrain}), le \emph{cerveau moyen} (mésencéphale, \an{midbrain}) et le \emph{cerveau antérieur} (prosencéphale, \an{forebrain}), comme illustré en Figure~\ref{fig:cerveau}.
Ce découpage tripartite est aussi souvent associées à trois étapes successives de l’évolution phylogénétique. 
