...
Alexander Maye et Andreas Engel démontrent par cette méthode que leur robot acquièrt une maitrise des \og contingences sensorimotrice \fg\ (voir Section \ref{sec:SMC}).
...
Sur la base de ces fondements théoriques je propose un programme de recherche qui inclut les principes suivants. 
...
\begin{enumerate}[itemsep=0pt, parsep=0pt, partopsep=0pt]
	...
	\begin{itemize}[label=\scalebox{.85}{$\diamond$}, itemsep=0pt, topsep=0pt, parsep=0pt, partopsep=0pt]
		\item Apprentissage hiérarchique bottom-up
