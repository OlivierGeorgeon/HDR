...
\section{Statut représentationnel des signaux sensoriels}

La revue de l'état de l'art montre que les signaux sensoriels reçu par l'agent n'ont pas toujours le même statut. 
Je formalise une notion est souvent abordée implicitement: le \emph{statut représentationnel} qui fait la distinction entre les signaux sensoriels qui sont \emph{représentationnels} de ceux qui sont \emph{non-représentationnels}. 

Les signaux sensoriels markoviens sont représentationnels car ils constituent une représentation de l'état de l'environnement. 

En ce qui concerne les signaux non-markoviens, ils sont parfois représentationnels quand ils constituent une observation d'une propriété partielle de l'état de l'environnement. 
Ils sont non-représentationnels quand ils constituent un \an{feedback} résultant de l'action.

Cette distinction peut s'exprimer de manière formelle quand l'environnement est défini par un ensemble fini d'états 
Soit 

$S = {s_1, s_2, s_n}$. 
Un signal sensoriel pouvant prendre plusieurs valeurs $O = {o_1, o_2, o_j}$ est représentationnel 
