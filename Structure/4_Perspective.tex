...
\begin{table}[h!]
	...
	\begin{tabular}{|l|l|c|c|}
		...
		\texttt{focus-x} & facultatif & \texttt{translate}, \texttt{swipe}, \texttt{turn} & coordonnée x du point d'attention \\ \hline
		\texttt{focus-y} & facultatif & \texttt{translate}, \texttt{swipe}, \texttt{turn} & coordonnée y du point d'attention \\ \hline
		\texttt{color} & facultatif & toutes & couleur de la LED\\ \hline
		\texttt{duration} & facultatif & \texttt{translate}, \texttt{swipe} & durée \\ \hline
		\texttt{angle} & facultatif & \texttt{turn}, \texttt{turn-head}, \texttt{scan} & angle \\ \hline
		\texttt{caution} & facultatif & toutes & catégorie de prudence \\ \hline
	\end{tabular}
	\caption{Décisions primitives de PetitCat.
	}
