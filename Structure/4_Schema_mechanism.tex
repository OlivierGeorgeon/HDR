...
Dans cette expérimentation, l'agent dispose de six actions dont il ignore initialement la signification: 
...
\begin{figure}[ht]
	...
	\caption{Trace d'activité obtenue dans le \emph{Small Loop Challenge} \cite{georgeon_demonstrating_2013} Fig.~5}
	\label{fig:trace}
\end{figure}
